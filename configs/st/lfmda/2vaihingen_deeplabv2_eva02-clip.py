...
BACKBONE_TEACHER = 'eva02_large_patch14_clip_224'
PRETRAINED_TEACHER = 'ckpts/eva02_large_patch14_clip_224.merged2b_s4b_b131k.bin'
# student cfg
...
SNAPSHOT_DIR = f'./log/lfmda/{MODEL_STUDENT}_{BACKBONE_STUDENT}/2vaihingen_{MODEL_TEACHER}_{BACKBONE_TEACHER}'
