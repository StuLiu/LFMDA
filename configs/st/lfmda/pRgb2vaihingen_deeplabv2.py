...
SOURCE_DATA_CONFIG = dict(
    ...
    transforms=abl.Compose([
        abl.RandomCrop(512, 512),
        abl.OneOf([
            abl.HorizontalFlip(True),
            abl.VerticalFlip(True),
            abl.RandomRotate90(True)
        ], p=0.75),
        abl.Normalize(mean=(120.8217, 81.8250, 81.2344),
...
SNAPSHOT_DIR = f'./log/lfmda/{MODEL_STUDENT}_{BACKBONE_STUDENT}/pRgb2vaihingen'
