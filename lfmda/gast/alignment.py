...
from lfmda.gast.class_ware_whiten import ClassWareWhitening
from lfmda.gast.coral import CoralLoss, ImageLevelCoralLoss
from lfmda.gast.mmd import MMDLoss, ImageLevelMMDLoss
from lfmda.gast.pseudo_generation import pseudo_selection
...
class Aligner:
    ...
    def __init__(self, logger, feat_channels=64, class_num=7, ignore_label=-1, decay=0.999, topk=32, down_scale=16, resume=None):
...
if __name__ == '__main__':
    ...
    from lfmda.utils.tools import loss_calc
