...
def overlay_segmentation_cv2(original_image: np.ndarray, segmentation_result: np.ndarray, color_list):
    # 创建与原始图像大小一致的画布
    ...
    for class_id, color in enumerate(color_list):
        ...
        overlay[mask] = color
    # rgb + overlay
    overlay_rgb = original_image * 0.68 + overlay * 0.32
...
if __name__ == '__main__':
    from lfmda.datasets.loveda import LoveDA
    from lfmda.datasets.isprsda import IsprsDA
