...
if __name__ == '__main__':
    ...
    # vit = EvaSeg(512, 'timm/eva02_base_patch14_224', num_classes=6, patch_size=14).cuda()
    # vit.init_pretrained('/home/liuwang/liuwang_data/documents/projects/NonDA2/ckpts/backbones/eva/eva02_base_patch14_224.mim_in22k.bin')

    # vit = EvaSeg(512, 'timm/eva02_large_patch14_224', num_classes=6, patch_size=14).cuda()
    # vit.init_pretrained('/home/liuwang/liuwang_data/documents/projects/NonDA2/ckpts/backbones/eva/eva02_large_patch14_224.mim_m38m.bin')

    vit = EvaSeg(512, 'timm/eva02_large_patch14_clip_224', num_classes=6, patch_size=14).cuda()
    vit.init_pretrained('/home/liuwang/liuwang_data/documents/projects/NonDA2/'
                        'ckpts/backbones/eva/eva02_large_patch14_clip_224.merged2b_s4b_b131k.bin')
