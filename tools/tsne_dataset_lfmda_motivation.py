...
if __name__ == '__main__':
    ...
    parser.add_argument('--tea', type=str,
                        default='log/lfmda/Deeplabv2_resnet101/2potsdam/src_warmup_s/Potsdam_tea_curr.pth')
    parser.add_argument('--stu', type=str,
                        default='log/lfmda/Deeplabv2_resnet101/2potsdam/src_warmup_s/Potsdam_stu_curr.pth')
